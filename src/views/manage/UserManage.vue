<template>
  <div class="manage-content">
    <!-- 输入框容器 -->
<!--    <el-affix :offset="90" position="top">-->
...
<!--    </el-affix>-->
    ...
    >
      ...
      <el-table-column prop="ID" label="帐号" sortable width="80"/>
      <el-table-column prop="Username" label="姓名" sortable show-overflow-tooltip width="80"/>
      <el-table-column prop="Email" label="邮箱" show-overflow-tooltip width="200"/>
      <el-table-column prop="Phone" label="电话" show-overflow-tooltip width="150"/>
      <el-table-column
          prop="Department"
          label="部门"
